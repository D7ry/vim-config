...
vim.api.nvim_create_user_command('P4a', function()
    ...
    -- Define the Perforce annotate command
    local cmd = 'p4.exe annotate -u -c -q ' .. windows_file_path
...
vim.api.nvim_create_user_command('P4aa', function()
    -- Get the current buffer number
    local buf = vim.api.nvim_get_current_buf()
    ...
    -- Define the Perforce annotate command
    local cmd = 'p4.exe annotate -a -u -c -q ' .. windows_file_path
